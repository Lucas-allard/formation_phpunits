...
class CrudTest extends TestCase
{
    ...
    public function testItCanCreateReportUsingPostRequest(): BugReport
    {
        ...
        $response = $this->client->post("http://localhost/formation_php_unit/src/add.php", $postData);
    ...
    public function testItCanUpdateReportUsingPostRequest(BugReport $bugReport): BugReport
    {
        ...
        $response = $this->client->post("http://localhost/formation_php_unit/src/update.php", $postData);
        $response = json_decode($response, true);
        self::assertEquals(200, $response['statusCode']);
    ...
    public function testItCanDeleteReportUsingPostRequest(BugReport $bugReport)
    {
        ...
        $response = $this->client->post("http://localhost/formation_php_unit/src/delete.php", $postData);
        $response = json_decode($response, true);
        self::assertEquals(200, $response['statusCode']);
